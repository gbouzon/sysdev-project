                ...
                <?php
                    if (isset($_SESSION['user_id']) && $_SESSION['user_id'] == $data->user_id) {
                        ...
                        if (isset($_SESSION['role']) && $_SESSION['role'] != '1') 
                            echo "&ensp;<a class=\"delete-link\" href='/User/delete/$data->user_id' class='delete-link' onclick='return confirm(\"Are you sure you want to delete your account?\");' >". "Delete User" ."</a>";
                    }
                    echo "</div>"; 
                ?>
            </div>
