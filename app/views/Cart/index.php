<html>
    ...
    <body>
        <div class='container'>
            ...
            <?php 
                if ($data != null) { 
                    echo "<a href='/Cart/clearCart/$order_detail->order_id' class='btn btn-success' id='clearCart'>Clear Cart</a>
                        <a href='' class='btn btn-success' id='orderPlace'>Place Order</a>";
                }
            ?>
        </div>
    </body>
